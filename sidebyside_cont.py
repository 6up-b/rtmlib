...
def error_to_color(err, max_deg=110):
    if np.isnan(err):
        return (255, 255, 255)
...
def draw_pose_silhouette(
    ...
    #outer black outline so the hull stands out against the video
    cv2.drawContours(img, [hull], -1, (64, 64, 64), thickness + 4)
